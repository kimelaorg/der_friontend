...
export { Clients } from './DemoPages/Dashboards/clients/clients';
export { Sales } from './DemoPages/Dashboards/sales/sales';
export { Transactions } from './DemoPages/Dashboards/transactions/transactions';
export { Purchasing } from './DemoPages/Dashboards/purchasing/purchasing';
export { Reports } from './DemoPages/Dashboards/reports/reports';
...
export { Products } from './DemoPages/Components/products/products';
export { Discounts } from './DemoPages/Components/discounts/discounts';
export { Users } from './DemoPages/Components/users/users';
export { Orders } from './DemoPages/Components/orders/orders';
export { Shipping } from './DemoPages/Components/shipping/shipping';
export { Cartegories } from './DemoPages/Components/cartegories/cartegories';
